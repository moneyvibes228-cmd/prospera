...
} from '@distributeur/lib/registries/fournisseurs-registry'
import { REGISTRE_COMMANDES } from '@distributeur/lib/registries/commandes-registry'
import { RESEAU_CONSOLIDE_DIST } from '@distributeur/lib/registries/zones-registry'
import { CA_SPARKLINE_REGISTRY, ENTREPRISE_REGISTRY } from '@distributeur/lib/registries/entreprise-registry'
  ...
  return [
    {
      ...
      action_href: '/distributeur/pilotage-financier',
    },
    {
      cle: 'benefice_net',
      ...
      action_href: '/distributeur/comptabilite',
    },
    {
      cle: 'credit_client',
      ...
      action_href: '/distributeur/relances',
    },
    {
      ...
      action_href: '/distributeur/approvisionnement?tab=fournisseurs',
    },
    {
      cle: 'ca_jour',
      label: 'CA journalier',
      ...
      action_href: '/distributeur/commandes',
    },
    {
      cle: 'ca_mois',
      label: 'CA mensuel',
      ...
      action_href: '/distributeur/equipe',
    },
    {
      cle: 'ca_annuel',
