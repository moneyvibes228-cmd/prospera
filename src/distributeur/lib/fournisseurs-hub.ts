import type { CommandeFournisseur, Fournisseur, ProduitFournisseur } from '@distributeur/types'
import { REGISTRE_FOURNISSEURS, DETTE_FOURNISSEURS_TOTALE, DETTE_FOURNISSEURS_ECHUE, getFournisseurById } from '@distributeur/lib/registries/fournisseurs-registry'
import { REGISTRE_COMMANDES_FOURNISSEURS, getCommandesDuFournisseur } from '@distributeur/lib/registries/commandes-fournisseurs-registry'
