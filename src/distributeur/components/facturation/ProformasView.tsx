...
import type { Proforma, ProformaStatut } from '@distributeur/types'
...
import { isPortefeuilleRole } from '@distributeur/lib/hub-context'
...
} from '@distributeur/lib/proforma-builder'
