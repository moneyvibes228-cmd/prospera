...
import type { EFactureMeta, LigneFacture } from '@distributeur/types'
import { formatFcfaFull } from '@distributeur/lib/utils'
import { ENTREPRISE_REGISTRY } from '@distributeur/lib/registries/entreprise-registry'
import { TVA_PCT, MODE_PAIEMENT_LABEL } from '@distributeur/lib/proforma-builder'
import type { ModePaiementFacture } from '@distributeur/types'
