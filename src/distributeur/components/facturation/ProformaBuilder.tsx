...
import type { LigneFacture, ModePaiementFacture, CanalEnvoiProforma, Proforma } from '@distributeur/types'
...
import { genererReference } from '@distributeur/lib/facturation-workflow'
import {
