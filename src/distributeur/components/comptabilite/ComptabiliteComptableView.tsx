...
import { formatFcfa, cn } from '@distributeur/lib/utils'
import {
...
} from '@distributeur/lib/comptable-poste-builder'
import {
  ECRITURES_JOURNAL, SUSPENS_COMPTABLES, RAPPROCHEMENTS,
} from '@distributeur/lib/registries/comptabilite-registry'
import { STATUT_ECRITURE_STYLE, STATUT_RAPPROCHEMENT_STYLE, getReferentielCompta } from '@distributeur/lib/comptabilite-dg-builder'
