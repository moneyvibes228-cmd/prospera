...
} from '@distributeur/lib/comptabilite-dg-builder'
import { buildEcheancierFournisseurs } from '@distributeur/lib/reappro-engine'
import { DETTE_FOURNISSEURS_TOTALE, DETTE_FOURNISSEURS_ECHUE } from '@distributeur/lib/registries/fournisseurs-registry'
    ...
    <div className="p-6 max-w-6xl space-y-5">
      ...
      <div className="grid lg:grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
          <div className="px-4 py-3 border-b border-slate-100 flex items-center justify-between">
            ...
            <Link href="/distributeur/facturation" className="text-[10px] text-amber-700 font-semibold inline-flex items-center gap-0.5 hover:underline">
      ...
      <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
        <div className="px-4 py-3 border-b border-slate-100 flex items-center justify-between flex-wrap gap-2">
          ...
          <Link href="/distributeur/approvisionnement?tab=fournisseurs" className="text-[10px] text-amber-700 font-semibold inline-flex items-center gap-0.5 hover:underline">
