...
import { ClotureVisiteModal } from '@distributeur/components/terrain/ClotureVisiteModal'
...
} from '@distributeur/lib/tournee-hub'
...
} from '@distributeur/lib/itineraire-builder'
import type { Visite } from '@distributeur/types'

const CarteTournee = dynamic(() => import('@distributeur/components/shared/CartePerimetreTerrain'), {
  ssr: false,
  loading: () => (
