...
import type { ResultatVisite, Visite } from '@distributeur/types'
import type { ClotureVisitePayload } from '@distributeur/contexts/TerrainWorkflowContext'
import { formatFcfa } from '@distributeur/lib/utils'
import { haversineKm } from '@distributeur/lib/cartographie-distance-builder'
