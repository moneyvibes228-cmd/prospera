...
import type { AiInsightOperationnel, DomaineInsightDG } from '@distributeur/lib/mock-dg-kpis-builder'
import { DOMAINE_INSIGHT_LABELS } from '@distributeur/lib/mock-dg-kpis-builder'
