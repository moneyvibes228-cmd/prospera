...
import {
  ...
  type ZonePilotageDG,
} from '@distributeur/lib/zones-pilotage-dg'
import {
...
} from '@distributeur/lib/magasins-pilotage-dg'
import type { ModeCarteDG } from '@distributeur/components/dashboard/CarteZonesDG'
import type { TypeMagasin } from '@distributeur/types'
import { buildAnalyseDistanceReseau } from '@distributeur/lib/cartographie-distance-builder'

const CarteZonesDG = dynamic(() => import('@distributeur/components/dashboard/CarteZonesDG'), {
  ssr: false,
  loading: () => (
