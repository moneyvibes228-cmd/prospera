...
import { buildReglesMarketing, buildNuitMarketing } from '@distributeur/lib/automation/marketing-automations'
import { buildSyntheseAutomation, MODE_STYLE, MODE_LABEL, CANAL_ICON } from '@distributeur/lib/automation/automation-types'
import { buildCalendrierSocial, buildPerfSocial, buildInboxSocial, ANGLE_META } from '@distributeur/lib/social-builder'
import { audienceAdressable, exclusionsCampagne } from '@distributeur/lib/automation/garde-fous'
import { getLeads } from '@distributeur/lib/marketing-dg-builder'
      ...
      <div className="grid lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 bg-white rounded-xl border border-slate-200 p-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link href="/distributeur/automatisations" className="text-[10px] font-semibold text-indigo-600 hover:underline flex items-center gap-1">
        ...
        <div className="space-y-3">
          <Link href="/distributeur/marketing/social" className="block bg-gradient-to-br from-pink-50 to-violet-50 rounded-xl border border-pink-200 p-4 hover:shadow-md transition-shadow">
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-4">
            ...
            <Link href="/distributeur/marketing/social" className="text-[10px] font-semibold text-sky-600 hover:underline mt-2 inline-flex items-center gap-1">
              Traiter la boîte de réception <ArrowRight size={10} />
            </Link>
          </div>

          <Link href="/distributeur/marketing" className="block bg-white rounded-xl border border-slate-200 p-4 hover:border-amber-300 transition-colors">
            <div className="flex items-center gap-2">
