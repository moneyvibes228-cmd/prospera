...
import { buildCockpitRecouvrement, CAPACITE_JOUR } from '@distributeur/lib/recouvrement-cockpit-builder'
import { buildSyntheseAutomation, CANAL_ICON } from '@distributeur/lib/automation/automation-types'
import { STATUT_PROMESSE_STYLE } from '@distributeur/lib/automation/recouvrement-automations'
    ...
    <div className="p-6 max-w-[90rem] space-y-5">
      ...
      <div className="bg-gradient-to-br from-slate-50 to-emerald-50 rounded-xl border border-emerald-200 p-4">
        <div className="flex items-center gap-2 mb-3">
          ...
          <Link href="/distributeur/automatisations" className="ml-auto text-[10px] font-semibold text-emerald-700 hover:underline flex items-center gap-1">
