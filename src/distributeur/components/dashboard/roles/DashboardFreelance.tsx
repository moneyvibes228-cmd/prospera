...
import { getCommandesHub, getPdvHub } from '@distributeur/lib/mock-distribution'
import { useHubContext } from '@distributeur/lib/use-hub-context'
import { getTourneeHub, DATE_AUJOURDHUI, MOTIF_VISITE_STYLE, STATUT_VISITE_STYLE } from '@distributeur/lib/tournee-hub'
      ...
      <div className="grid lg:grid-cols-3 gap-4 mb-6">
        <div className="lg:col-span-2 bg-white rounded-xl border border-slate-200 overflow-hidden">
          <div className="flex items-center justify-between px-4 py-3 border-b border-slate-100">
            ...
            <Link href="/distributeur/mon-activite" className="flex items-center gap-1 text-xs font-semibold text-lime-700 hover:text-lime-800">
