...
import { buildBonsPreparation, buildVagues, buildChargeJour } from '@distributeur/lib/picking-engine'
import { buildPlanExpedition } from '@distributeur/lib/expedition-engine'
import { buildReceptionsAttendues } from '@distributeur/lib/reception-engine'
import { buildClassificationABC, buildTachesComptage } from '@distributeur/lib/inventaire-engine'
import { getTopologie, preparateursPresents } from '@distributeur/lib/registries/entrepot-logistique-registry'
        ...
        {[
          {
            ...
            href: '/distributeur/entrepot?tab=preparation',
          },
          {
            ...
            href: '/distributeur/entrepot?tab=expedition',
          },
          {
          ...
          },
          {
            ...
            href: '/distributeur/entrepot?tab=inventaire',
          },
        ].map(k => {
          const Icon = k.icon
          return (
      ...
      <div className="grid lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 bg-white rounded-xl border border-slate-200 p-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link href="/distributeur/entrepot?tab=preparation" className="text-[11px] font-bold text-blue-600 hover:text-blue-700 inline-flex items-center gap-1">
