...
import { buildPlanTransferts, buildSanteStock } from '@distributeur/lib/transferts-engine'
import { buildJournalAutomatisation } from '@distributeur/lib/automation-journal'
import { buildBonsPreparation, buildChargeJour } from '@distributeur/lib/picking-engine'
import { buildReceptionsAttendues } from '@distributeur/lib/reception-engine'
  ...
  return (
    <div className="p-6 max-w-7xl space-y-5">
      ...
      <div className="rounded-xl border border-slate-800 bg-slate-900 text-white p-4">
        ...
        <Link
          href="/distributeur/stock?tab=automatisation"
        ...
        {[
          {
            ...
            href: '/distributeur/approvisionnement?tab=reappro',
          },
          {
            ...
            icon: TrendingDown,
            color: 'text-red-600',
            href: '/distributeur/stock?tab=sante',
          },
          {
            ...
            href: '/distributeur/stock?tab=transferts',
          },
          {
            ...
            href: '/distributeur/entrepot?tab=reception',
          },
        ].map(k => {
          const Icon = k.icon
          return (
      ...
      <div className="grid lg:grid-cols-2 gap-4">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link href="/distributeur/stock?tab=transferts" className="text-[11px] font-bold text-indigo-600 hover:text-indigo-700">
              Tout voir →
            </Link>
          </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link href="/distributeur/approvisionnement?tab=fournisseurs" className="text-[11px] font-bold text-orange-600 hover:text-orange-700">
              Tout voir →
            </Link>
          </div>
      ...
      <div className="bg-white rounded-xl border border-slate-200 p-4">
        <div className="flex items-center justify-between mb-3">
          ...
          <Link href="/distributeur/entrepot" className="text-[11px] font-bold text-slate-600 hover:text-slate-800">
            Vue opérations →
          </Link>
        </div>
