...
import type { ZonePilotageDG, EntrepotCarteDG } from '@distributeur/lib/zones-pilotage-dg'
import type { MagasinCarteDG, FluxEntrepotMagasinDG } from '@distributeur/lib/magasins-pilotage-dg'
import type { SuggestionImplantation } from '@distributeur/lib/cartographie-distance-builder'
