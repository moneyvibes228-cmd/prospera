...
import type { CommandeFournisseur, StatutCommandeFournisseur } from '@distributeur/types'
import {
  REGISTRE_COMMANDES_FOURNISSEURS, STATUT_CF_STYLE, STATUT_PAIEMENT_STYLE, PIPELINE_CF,
} from '@distributeur/lib/registries/commandes-fournisseurs-registry'
import { genererCommandesSuggerees } from '@distributeur/lib/reappro-engine'
