...
import { useProspectionWorkflow } from '@distributeur/contexts/ProspectionWorkflowContext'
...
} from '@distributeur/lib/registries/prospection-registry'
...
const CarteRecensement = dynamic(() => import('@distributeur/components/shared/CartePerimetreTerrain'), {
  ssr: false,
  loading: () => (
