...
import { buildPdvRapportDG, buildPdvContexteCommercial, PIPELINE_STYLE } from '@distributeur/lib/pdv-rapport-builder'
import { useAuth } from '@distributeur/contexts/AuthContext'
import { formatFcfa, scoreBg } from '@distributeur/lib/utils'
...
export function PdvRapportView({ pdvId }: Props) {
  ...
  return (
    <div className="p-6 max-w-6xl space-y-5">
      <Link href="/distributeur/points-de-vente" className="inline-flex items-center gap-1 text-xs text-slate-500 hover:text-amber-600">
