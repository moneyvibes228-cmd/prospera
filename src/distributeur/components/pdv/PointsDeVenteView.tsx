...
import { getPdvHub } from '@distributeur/lib/mock-distribution'
...
} from '@distributeur/lib/pdv-rapport-builder'
import { formatFcfa, scoreBg } from '@distributeur/lib/utils'
import type { PipelineStage, TypeMagasin } from '@distributeur/types'
