...
import { scopeAuPerimetre } from '@distributeur/lib/hub-context'
import { getPerimetre } from '@distributeur/lib/perimetre'
import { buildTournees, type TourneeCommercial } from '@distributeur/lib/tournees-builder'
import { REGISTRE_VISITES, DATE_AUJOURDHUI } from '@distributeur/lib/registries/tournees-registry'
import { cn, formatFcfa } from '@distributeur/lib/utils'
import type { CarteMarker, CarteRoute } from '@distributeur/components/shared/CartePerimetreTerrain'

const CarteEquipe = dynamic(() => import('@distributeur/components/shared/CartePerimetreTerrain'), {
  ssr: false,
  loading: () => (
