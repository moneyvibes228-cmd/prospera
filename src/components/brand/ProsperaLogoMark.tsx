...
/** Marque Prospera — lettre P (remplace le logo Next.js) */
export function ProsperaLogoMark({ size = 'md', className }: Props) {
  const s = SIZES[size]
  return (
    <div
      className={cn(
        'inline-flex items-center justify-center rounded-xl bg-gradient-to-br from-teal-600 to-teal-400 shadow-md flex-shrink-0',
        s.box,
        className,
      )}
      aria-hidden
