...
import { useRecouvrementWorkflow } from '@/contexts/RecouvrementWorkflowContext'
import { getRelancesHub } from '@/lib/mock-distribution'
import { useHubContext } from '@/lib/use-hub-context'
import { getPdvById } from '@/lib/registries/pdv-registry'
import { EVENEMENT_LABEL, type CanalRelance, type EvenementRecouvrementType } from '@/lib/recouvrement-workflow'
import { formatFcfa } from '@/lib/utils'
import { optimiserItineraire, lienNavigationMulti, formatDuree } from '@/lib/itineraire-builder'
import type { CarteMarker } from '@/components/shared/CartePerimetreTerrain'

const CarteDebiteurs = dynamic(() => import('@/components/shared/CartePerimetreTerrain'), {
  ssr: false,
  loading: () => (
