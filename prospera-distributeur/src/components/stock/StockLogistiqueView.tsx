...
import { TransfertsPanel } from '@/components/logistique/TransfertsPanel'
import { SanteStockPanel } from '@/components/logistique/SanteStockPanel'
import { JournalAutomatisationPanel } from '@/components/logistique/JournalAutomatisationPanel'
