...
import { REGLES_CONQUETE, type StatutZone } from '@/lib/registries/prospection-registry'
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <div className="bg-white rounded-xl border border-slate-200 p-4 shadow-sm">
            <div className="flex items-center justify-between gap-2 mb-3">
              ...
              <Link href="/prospection" className="text-[11px] font-semibold text-indigo-600 hover:text-indigo-800">
                Ouvrir le carnet →
              </Link>
            </div>
