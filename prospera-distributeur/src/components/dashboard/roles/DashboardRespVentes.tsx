...
import { ValidationsPanel } from '@/components/validations/ValidationsPanel'
...
import { buildObjectifs } from '@/lib/objectifs-builder'
    ...
    <div className="p-6 max-w-7xl">
      ...
      <div className={cn(
        ...
        <div className="flex items-start justify-between gap-4">
          ...
          <Link href="/objectifs" className="shrink-0 text-[10px] font-bold text-slate-700 hover:text-slate-900 inline-flex items-center gap-0.5 bg-white border border-slate-200 rounded-lg px-2.5 py-1.5">
