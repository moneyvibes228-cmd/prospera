...
import { buildTournees } from '@/lib/tournees-builder'
        ...
        <div className="space-y-4">
          <div className="bg-white rounded-xl border border-slate-200 p-4">
            <div className="flex items-center gap-2 mb-3">
              ...
              <Link href="/tournees" className="ml-auto text-[10px] font-bold text-indigo-600 hover:text-indigo-800 inline-flex items-center gap-0.5">
