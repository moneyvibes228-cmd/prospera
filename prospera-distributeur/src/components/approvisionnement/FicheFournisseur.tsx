...
import { buildFicheFournisseur } from '@/lib/fournisseurs-hub'
import { STATUT_FOURNISSEUR_STYLE } from '@/lib/registries/fournisseurs-registry'
import { STATUT_CF_STYLE } from '@/lib/registries/commandes-fournisseurs-registry'
