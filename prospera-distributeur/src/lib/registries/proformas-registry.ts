import type { LigneFacture, Proforma, ProformaStatut, CanalEnvoiProforma, ModePaiementFacture } from '@/types'
import { REGISTRE_PDV, getPdvById } from './pdv-registry'
import { REGISTRE_STOCK } from './stock-registry'
import { calculerTotaux, ligneDepuisProduit, scoreAcceptationIA, suggestionIA } from '@/lib/proforma-builder'
